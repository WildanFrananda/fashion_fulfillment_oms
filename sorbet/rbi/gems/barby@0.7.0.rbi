...
# pkg:gem/barby#lib/barby/version.rb:1
module Barby; end
...
# end
#
# pkg:gem/barby#lib/barby/barcode.rb:35
class Barby::Barcode
...
#
# pkg:gem/barby#lib/barby/barcode.rb:107
...
#
# pkg:gem/barby#lib/barby/barcode.rb:112
...
#
# pkg:gem/barby#lib/barby/outputter.rb:21
class Barby::Outputter
  # An outputter instance will have access to a Barcode
  #
  # pkg:gem/barby#lib/barby/outputter.rb:27
  def initialize(barcode); end

  # pkg:gem/barby#lib/barby/outputter.rb:23
  def barcode; end
  ...
  #
  # pkg:gem/barby#lib/barby/outputter.rb:93
  ...
  # in the same way
  #
  # pkg:gem/barby#lib/barby/outputter.rb:71
  ...
  #
  # pkg:gem/barby#lib/barby/outputter.rb:82
  def encoding(reload = T.unsafe(nil)); end

  # pkg:gem/barby#lib/barby/outputter.rb:61
  def two_dimensional?; end
  ...
  #
  # pkg:gem/barby#lib/barby/outputter.rb:113
  ...
  class << self
    ...
    #
    # pkg:gem/barby#lib/barby/outputter.rb:48
    def register(*method_names); end
  end
end

# pkg:gem/barby#lib/barby/version.rb:2
module Barby::VERSION; end

# pkg:gem/barby#lib/barby/version.rb:3
Barby::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/barby#lib/barby/version.rb:4
Barby::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/barby#lib/barby/version.rb:7
Barby::VERSION::STRING = T.let(T.unsafe(nil), String)

# pkg:gem/barby#lib/barby/version.rb:5
