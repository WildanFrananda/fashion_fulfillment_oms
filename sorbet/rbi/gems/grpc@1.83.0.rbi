...
# GRPC is the general RPC module
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:16
module GRPC
  extend ::GRPC::DefaultLogger

  private

  # pkg:gem/grpc#src/ruby/lib/grpc/grpc.rb:19
  ...
  class << self
    # pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:17
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:219
class GRPC::Aborted < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:220
...
# data to a call
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:42
class GRPC::ActiveCall
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:88
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:585
  def attach_peer_cert(peer_cert); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:181
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:500
  def bidi_streamer(requests, metadata: T.unsafe(nil), &blk); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:47
  def cancel(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:47
  def cancel_with_status(*_arg0, **_arg1, &_arg2); end

  # cancelled indicates if the call was cancelled
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:134
  def cancelled?; end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:399
  def client_streamer(requests, metadata: T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:46
  def deadline; end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:303
  ...
  # @return [Enumerator] if no block was given
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:336
  def each_remote_read_then_finish; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:275
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:162
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:578
  def merge_metadata_to_send(new_metadata = T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:47
  def metadata(*_arg0, **_arg1, &_arg2); end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:140
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:570
  def op_is_done; end

  # operation provides a restricted view of this ActiveCall for use as
  # a Operation.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:152
  def operation; end

  # output_metadata are provides access to hash that can be used to
  # save metadata to be sent as trailer
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:129
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:229
  def read_unary_request; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:166
  ...
  # raising BadStatus
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:258
  def remote_read; end
  ...
  # marshalled.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:199
  ...
  # @return [Object] the response received from the server
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:356
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:541
  def run_server_bidi(mth, interception_ctx); end

  # Sends the initial metadata that has yet to be sent.
  # Does nothing if metadata has already been sent for this call.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:118
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:214
  ...
  # @return [Enumerator|nil] a response Enumerator
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:442
  def server_streamer(req, metadata: T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:235
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:146
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:47
  def trailing_metadata(*_arg0, **_arg1, &_arg2); end

  # Waits till an operation completes
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:562
  def wait; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:47
  def write_flag(*_arg0, **_arg1, &_arg2); end
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:611
  def maybe_finish_and_close_call_locked; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:628
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:594
  ...
  # note this is idempotent
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:604
  ...
  # a list, multiple metadata for its key are sent
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:622
  ...
  class << self
    ...
    #
    # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:63
    def client_invoke(call, metadata = T.unsafe(nil)); end

    # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:637
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:638
class GRPC::ActiveCall::InterceptableView
  extend ::Forwardable

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:643
  def initialize(wrapped); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def deadline(*_arg0, **_arg1, &_arg2); end
end
...
class GRPC::ActiveCall::MultiReqView
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def cancelled?(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def deadline(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def each_remote_read(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def merge_metadata_to_send(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def metadata(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def metadata_sent(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def metadata_to_send(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def output_metadata(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def peer(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def peer_cert(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def send_initial_metadata(*_arg0, **_arg1, &_arg2); end
end
...
class GRPC::ActiveCall::Operation
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/active_call.rb:640
  def start_call(*_arg0, **_arg1, &_arg2); end
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:169
class GRPC::AlreadyExists < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:170
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:32
class GRPC::BadStatus < ::StandardError
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:69
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:59
  def to_status; end

  class << self
    # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:77
...
# server.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/bidi_call.rb:22
class GRPC::BidiCall
  include ::GRPC::Core::CallOps
  include ::GRPC::Core::StatusCodes
  include ::GRPC::Core::TimeConsts
  ...
  #     been received. Should always be true for server calls
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/bidi_call.rb:44
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/bidi_call.rb:114
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/bidi_call.rb:70
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/bidi_call.rb:92
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:35
class GRPC::ClientInterceptor < ::GRPC::Interceptor
  ...
  # @param [Hash] metadata
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:86
  ...
  # @param [Hash] metadata
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:58
  ...
  # @param [Hash] metadata
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:44
  ...
  # @param [Hash] metadata
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:72
...
# to send requests.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:24
class GRPC::ClientStub
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:97
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:417
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:226
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:56
  ...
  # @return [Object] the response received from the server
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:160
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:306
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:472
  def execute_with_interceptors(rpc_type, intercept_args, credentials, method, call); end

  # Handles return_op lifecycle branching
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:489
  def handle_return_op(call, return_op, metadata, credentials, method, &block); end
  ...
  #   the call
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:454
  def new_active_call(method, marshal, unmarshal, deadline: T.unsafe(nil), parent: T.unsafe(nil), credentials: T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:510
  def resolve_call_metadata(metadata, _credentials, _method); end

  class << self
    # setup_channel is used by #initialize to constuct a channel from its
    # arguments.
    #
    # pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:33
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/client_stub.rb:29
GRPC::ClientStub::DEFAULT_TIMEOUT = T.let(T.unsafe(nil), GRPC::Core::TimeSpec)

# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:17
module GRPC::Core
  private
...
# API.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:20
...
# and Unavailable.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:93
GRPC::Core::StatusCodes::ABORTED = T.let(T.unsafe(nil), Integer)

# AlreadyExists means an attempt to create an entity failed because one
# already exists.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:53
GRPC::Core::StatusCodes::ALREADY_EXISTS = T.let(T.unsafe(nil), Integer)

# Canceled indicates the operation was canceled (typically by the caller).
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:25
GRPC::Core::StatusCodes::CANCELLED = T.let(T.unsafe(nil), Integer)

# DataLoss indicates unrecoverable data loss or corruption.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:128
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:45
...
#      same resource.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:85
GRPC::Core::StatusCodes::FAILED_PRECONDITION = T.let(T.unsafe(nil), Integer)

# Internal errors. Means some invariants expected by underlying system has
# been broken. If you see one of these errors, something is very broken.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:116
...
# file name).
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:38
...
# found.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:49
GRPC::Core::StatusCodes::NOT_FOUND = T.let(T.unsafe(nil), Integer)

# OK is returned on success.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:22
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:108
...
# and Unavailable.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:125
GRPC::Core::StatusCodes::UNAVAILABLE = T.let(T.unsafe(nil), Integer)

# Unimplemented indicates operation is not implemented or not
# supported/enabled in this service.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:112
...
# this error.
#
# pkg:gem/grpc#src/ruby/lib/grpc/core/status_codes.rb:32
...
module GRPC::Core::TimeConsts
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/core/time_consts.rb:36
  def from_relative_time(timeish); end

  class << self
    # pkg:gem/grpc#src/ruby/lib/grpc/core/time_consts.rb:53
    def from_relative_time(timeish); end
  end
end
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:269
class GRPC::DataLoss < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:270
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status DEADLINE_EXCEEDED
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:149
class GRPC::DeadlineExceeded < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:150
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:32
module GRPC::DefaultLogger
  # pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:33
  def logger; end
end

# pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:52
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:41
class GRPC::DefaultLogger::NoopLogger
  # pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:45
  def debug(_ignored); end

  # pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:42
  def info(_ignored); end

  # pkg:gem/grpc#src/ruby/lib/grpc/logconfig.rb:48
  def warn(_ignored); end
end

# GRPC status code corresponding to status FAILED_PRECONDITION
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:209
class GRPC::FailedPrecondition < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:210
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:24
module GRPC::GenericService
  mixes_in_class_methods ::GRPC::GenericService::Dsl

  class << self
    # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:194
    def included(o); end
    ...
    #
    # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:33
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:63
module GRPC::GenericService::Dsl
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:123
  def assert_can_marshal(cls); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:105
  ...
  # stream.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:114
  ...
  # stream.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:75
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:136
  def stream(cls); end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:119
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:43
class GRPC::GenericService::DuplicateRpcName < ::StandardError
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/service.rb:44
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/google_rpc_status_utils.rb:26
class GRPC::GoogleRpcStatusUtils
  class << self
    # pkg:gem/grpc#src/ruby/lib/grpc/google_rpc_status_utils.rb:27
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:154
class GRPC::InterceptionContext
  # @param interceptors [Array<GRPC::Interceptor>]
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:158
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:169
  def intercept!(type, args = T.unsafe(nil)); end
end

# Base class for interception in GRPC
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:21
class GRPC::Interceptor
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:26
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptor_registry.rb:22
class GRPC::InterceptorRegistry
  # Initialize the registry with an empty interceptor list
  # This is an EXPERIMENTAL API.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptor_registry.rb:33
  def initialize(interceptors = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptor_registry.rb:49
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptor_registry.rb:27
class GRPC::InterceptorRegistry::DescendantError < ::StandardError; end

# GRPC status code corresponding to status INTERNAL
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:249
class GRPC::Internal < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:250
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status INVALID_ARGUMENT
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:139
class GRPC::InvalidArgument < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:140
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status NOT_FOUND
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:159
class GRPC::NotFound < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:160
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# Notifier is useful high-level synchronization primitive.
#
# pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:18
class GRPC::Notifier
  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:22
  def initialize; end

  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:19
  def notified; end

  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:20
  def notified?; end

  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:35
  def notify(payload); end

  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:19
  def payload; end

  # pkg:gem/grpc#src/ruby/lib/grpc/notifier.rb:29
  def wait; end
end

# GRPC status code corresponding to status OK
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:109
class GRPC::Ok < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:110
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status OUT_OF_RANGE
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:229
class GRPC::OutOfRange < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:230
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# pkg:gem/grpc#src/ruby/lib/grpc.rb:30
GRPC::PURE_RUBY_CALL_CREDENTIALS_ENABLED = T.let(T.unsafe(nil), FalseClass)

# GRPC status code corresponding to status PERMISSION_DENIED
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:179
class GRPC::PermissionDenied < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:180
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# Pool is a simple thread pool.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:23
class GRPC::Pool
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:27
  def initialize(size, keep_alive: T.unsafe(nil)); end

  # Returns the number of jobs waiting
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:43
  def jobs_waiting; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:47
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:58
  def schedule(*args, &blk); end

  # Starts running the jobs in the thread pool.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:75
  def start; end

  # Stops the jobs in the pool
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:93
  def stop; end
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:111
  def forcibly_stop_workers; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:134
  def loop_execute_jobs(worker_queue); end

  # removes the threads from workers, and signal when all the
  # threads are complete.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:127
  def remove_current_thread; end
end

# Default keep alive period is 1s
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:25
GRPC::Pool::DEFAULT_KEEP_ALIVE = T.let(T.unsafe(nil), Integer)

# GRPC status code corresponding to status RESOURCE_EXHAUSTED
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:199
class GRPC::ResourceExhausted < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:200
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# RpcDesc is a Descriptor of an RPC method.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:20
class GRPC::RpcDesc < ::Struct
  include ::GRPC::Core::StatusCodes

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:191
  def arity_error(mth, want, msg); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:156
  def assert_arity_matches(mth); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:187
  def bidi_streamer?; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:179
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:105
  def handle_bidi_streamer(active_call, mth, inter_ctx); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:68
  def handle_client_streamer(active_call, mth, inter_ctx); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:50
  def handle_request_response(active_call, mth, inter_ctx); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:84
  def handle_server_streamer(active_call, mth, inter_ctx); end

  # @return [Proc] { |instance| marshalled(instance) }
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:34
  def marshal_proc; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:175
  ...
  #   being executed
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:117
  def run_server_method(active_call, mth, inter_ctx = T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:195
  def send_status(active_client, code, details, metadata = T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:183
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:43
  def unmarshal_proc(target); end
end

# Used to wrap a message class to indicate that it needs to be streamed.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:25
class GRPC::RpcDesc::Stream
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:28
  def initialize(type); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_desc.rb:26
  def type; end
...
# network.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:155
class GRPC::RpcServer
  ...
  # Interceptors are an EXPERIMENTAL API.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:217
  ...
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:160
  def add_http2_port(*_arg0, **_arg1, &_arg2); end

  # Sends RESOURCE_EXHAUSTED if there are too many unprocessed jobs
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:418
  ...
  #        above
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:333
  def handle(service); end

  # Sends UNIMPLEMENTED if the method is not implemented by this server
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:433
  def implemented?(an_rpc); end

  # handles calls to the server
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:448
  def loop_handle_server_calls; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:487
  ...
  #   the server to stop.
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:351
  def run; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:362
  ...
  #     stop_server
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:371
  def run_till_terminated_or_interrupted(signals, wait_interval = T.unsafe(nil)); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:280
  def running?; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:260
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:242
  def stop; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:284
  def stopped?; end

  # Can only be called while holding @run_mutex
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:267
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:294
  ...
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:534
  def add_rpc_descs_for(service); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:525
  def assert_valid_service_class(cls); end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:517
  def rpc_descs; end

  # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:521
  ...
  class << self
    ...
    # connect_md_proc.
    #
    # pkg:gem/grpc#src/ruby/lib/grpc/generic/rpc_server.rb:176
...
# This is an EXPERIMENTAL API.
#
# pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:97
class GRPC::ServerInterceptor < ::GRPC::Interceptor
  ...
  # @param [Method] method
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:143
  ...
  # @param [Method] method
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:117
  ...
  # @param [Method] method
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:105
  ...
  # @param [Method] method
  #
  # pkg:gem/grpc#src/ruby/lib/grpc/generic/interceptors.rb:130
...
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:189
class GRPC::Unauthenticated < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:190
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status UNAVAILABLE
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:259
class GRPC::Unavailable < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:260
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status UNIMPLEMENTED
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:239
class GRPC::Unimplemented < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:240
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end

# GRPC status code corresponding to status UNKNOWN
#
# pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:129
class GRPC::Unknown < ::GRPC::BadStatus
  # pkg:gem/grpc#src/ruby/lib/grpc/errors.rb:130
  def initialize(details = T.unsafe(nil), metadata = T.unsafe(nil), debug_error_string = T.unsafe(nil)); end
end
...
# pkg:gem/grpc#src/ruby/lib/grpc/structs.rb:15
